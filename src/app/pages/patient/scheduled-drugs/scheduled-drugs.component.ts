...
@Component({
  selector: 'app-scheduled-drugs',
  templateUrl: './scheduled-drugs.component.html',
  styleUrls: ['./scheduled-drugs.component.css']
})
export class ScheduledDrugsComponent implements OnInit {
 ...
 today;
  ...
  onSubmit() {
    ...
    this.signUpService.signUpPatient(patient).
    subscribe(() => {
